...
try:
    db=_mysql.connect("92.140.232.200","root","toto", "datamining")
except OperationalError:
    db=_mysql.connect("92.140.232.200","root","toto")
    db.query("CREATE DATABASE datamining")
    db.query("USE datamining")

# On se reconnecte automatiquement
db.ping(True)
db.query("""
CREATE TABLE IF NOT EXISTS datamining.sensors (
...
db.query("""
CREATE TABLE IF NOT EXISTS datamining.sensors_data (
    id INT NOT NULL AUTO_INCREMENT,
    sensor_id INT NOT NULL,
    CONSTRAINT sensorFK
        FOREIGN KEY (sensor_id)
        REFERENCES datamining.sensors(id),
